...
namespace esphome {
    namespace sofarsolar_inverter {
        ...
        public:
			...
			void set_pv_generation_today_max_percent_change(float max_percent_change);
            void set_pv_generation_total_max_percent_change(float max_percent_change);
            void set_load_consumption_today_max_percent_change(float max_percent_change);
            void set_load_consumption_total_max_percent_change(float max_percent_change);
            void set_battery_charge_today_max_percent_change(float max_percent_change);
            void set_battery_charge_total_max_percent_change(float max_percent_change);
            void set_battery_discharge_today_max_percent_change(float max_percent_change);
            void set_battery_discharge_total_max_percent_change(float max_percent_change);
            void set_total_active_power_inverter_max_percent_change(float max_percent_change);
            void set_pv_voltage_1_max_percent_change(float max_percent_change);
            void set_pv_current_1_max_percent_change(float max_percent_change);
            void set_pv_power_1_max_percent_change(float max_percent_change);
            void set_pv_voltage_2_max_percent_change(float max_percent_change);
            void set_pv_current_2_max_percent_change(float max_percent_change);
            void set_pv_power_2_max_percent_change(float max_percent_change);
            void set_pv_power_total_max_percent_change(float max_percent_change);
            void set_battery_power_total_max_percent_change(float max_percent_change);
            void set_battery_state_of_charge_total_max_percent_change(float max_percent_change);
            void set_desired_grid_power_max_percent_change(float max_percent_change);
            void set_minimum_battery_power_max_percent_change(float max_percent_change);
            void set_maximum_battery_power_max_percent_change(float max_percent_change);
            void set_energy_storage_mode_max_percent_change(float max_percent_change);
            void set_battery_conf_id_max_percent_change(float max_percent_change);
            void set_battery_conf_address_max_percent_change(float max_percent_change);
            void set_battery_conf_protocol_max_percent_change(float max_percent_change);
            void set_battery_conf_voltage_nominal_max_percent_change(float max_percent_change);
            void set_battery_conf_voltage_over_max_percent_change(float max_percent_change);
            void set_battery_conf_voltage_charge_max_percent_change(float max_percent_change);
            void set_battery_conf_voltage_lack_max_percent_change(float max_percent_change);
            void set_battery_conf_voltage_discharge_stop_max_percent_change(float max_percent_change);
            void set_battery_conf_current_charge_limit_max_percent_change(float max_percent_change);
            void set_battery_conf_current_discharge_limit_max_percent_change(float max_percent_change);
            void set_battery_conf_depth_of_discharge_max_percent_change(float max_percent_change);
            void set_battery_conf_end_of_discharge_max_percent_change(float max_percent_change);
            void set_battery_conf_capacity_max_percent_change(float max_percent_change);
            void set_battery_conf_cell_type_max_percent_change(float max_percent_change);
            void set_battery_conf_eps_buffer_max_percent_change(float max_percent_change);
			void set_battery_conf_control_max_percent_change(float max_percent_change);
			void set_grid_frequency_max_percent_change(float max_percent_change);
			void set_grid_voltage_phase_r_max_percent_change(float max_percent_change);
			void set_grid_current_phase_r_max_percent_change(float max_percent_change);
			void set_grid_power_phase_r_max_percent_change(float max_percent_change);
			void set_grid_voltage_phase_s_max_percent_change(float max_percent_change);
			void set_grid_current_phase_s_max_percent_change(float max_percent_change);
			void set_grid_power_phase_s_max_percent_change(float max_percent_change);
			void set_grid_voltage_phase_t_max_percent_change(float max_percent_change);
			void set_grid_current_phase_t_max_percent_change(float max_percent_change);
			void set_grid_power_phase_t_max_percent_change(float max_percent_change);
			void set_off_grid_power_total_max_percent_change(float max_percent_change);
			void set_off_grid_frequency_max_percent_change(float max_percent_change);
			void set_off_grid_voltage_phase_r_max_percent_change(float max_percent_change);
			void set_off_grid_current_phase_r_max_percent_change(float max_percent_change);
			void set_off_grid_power_phase_r_max_percent_change(float max_percent_change);
			void set_off_grid_voltage_phase_s_max_percent_change(float max_percent change);
			void set_off_grid_current_phase_s_max_percent_change(float max_percent change);
			void set_off_grid_power_phase_s_max_percent change(float max percent change);
			void set_off_grid_voltage_phase_t_max_percent change(float max percent change);
			void set_off_grid_current_phase_t_max percent change(float max percent change);
			void set_off_grid_power_phase_t_max percent change(float max percent change);
			void set_battery_active_control_max percent change(float max percent change);
			void set_battery_active_oneshot_max percent change(float max percent change);
			void set_power_control_max percent change(float max percent change);
            void set_active_power_export_limit_max percent change(float max percent change);
            void set_active_power_import_limit_max percent change(float max percent change);
            void set_reactive_power_setting_max percent change(float max percent change);
            void set_power_factor_setting_max percent change(float max percent change);
            void set_active_power_limit_speed_max percent change(float max percent change);
            void set_reactive_power_response_time_max percent change(float max percent change);
			void set_svg_fixed_reactive_power_setting_max percent change(float max percent change);
