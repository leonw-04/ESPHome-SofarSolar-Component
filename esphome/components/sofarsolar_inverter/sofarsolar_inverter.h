...
PV_GENERATION_TODAY = 1;
PV_GENERATION_TOTAL = 2;
LOAD_CONSUMPTION_TODAY = 3;
PV_GENERATION_TOTAL = 4;
BATTERY_CHARGE_TODAY = 5;
BATTERY_CHARGE_TOTAL = 6;
BATTERY_DISCHARGE_TODAY = 7;
BATTERY_DISCHARGE_TOTAL = 8;
TOTAL_ACTIVE_POWER_INVERTER = 9;
PV_VOLTAGE_1 = 10;
PV_CURRENT_1 = 11;
PV_POWER_1 = 12;
PV_VOLTAGE_2 = 13;
...
PV_POWER_2 = 15;
PV_POWER_TOTAL = 16;
BATTERY_POWER_TOTAL = 17;
BATTERY_STATE_OF_CHARGE_TOTAL = 18;
DESIRED_GRID_POWER = 19;
MINIMUM_BATTERY_POWER = 20;
MAXIMUM_BATTERY_POWER = 21;
ENERGY_STORAGE_MODE = 22;
BATTERY_CONF_ID = 23;
BATTERY_CONF_ADDRESS = 24;
BATTERY_CONF_PROTOCOL = 25;
BATTERY_CONF_VOLTAGE_NOMINAL = 26;
BATTERY_CONF_VOLTAGE_OVER = 27;
BATTERY_CONF_VOLTAGE_CHARGE = 28;
BATTERY_CONF_VOLTAGE_LACK = 29;
BATTERY_CONF_VOLTAGE_DISCHARGE_STOP = 30;
BATTERY_CONF_CURRENT_CHARGE_LIMIT = 31;
BATTERY_CONF_CURRENT_DISCHARGE_LIMIT = 32;
BATTERY_CONF_DEPTH_OF_DISCHARGE = 33;
BATTERY_CONF_END_OF_DISCHARGE = 34;
BATTERY_CONF_CAPACITY = 35;
BATTERY_CONF_CELL_TYPE = 36;
BATTERY_CONF_EPS_BUFFER = 37;
BATTERY_CONF_CONTROL = 38;
GRID_FREQUENCY = 39;
GRID_VOLTAGE_PHASE_R = 40;
GRID_CURRENT_PHASE_R = 41;
GRID_POWER_PHASE_R = 42;
GRID_VOLTAGE_PHASE_S = 43;
GRID_CURRENT_PHASE_S = 44;
GRID_POWER_PHASE_S = 45;
GRID_VOLTAGE_PHASE_T = 46;
GRID_CURRENT_PHASE_T = 47;
GRID_POWER_PHASE_T = 48;
OFF_GRID_POWER_TOTAL = 49;
OFF_GRID_FREQUENCY = 50;
OFF_GRID_VOLTAGE_PHASE_R = 51;
OFF_GRID_CURRENT_PHASE_R = 52;
OFF_GRID_POWER_PHASE_R = 53;
OFF_GRID_VOLTAGE_PHASE_S = 54;
OFF_GRID_CURRENT_PHASE_S = 55;
OFF_GRID_POWER_PHASE_S = 56;
OFF_GRID_VOLTAGE_PHASE_T = 57;
OFF_GRID_CURRENT_PHASE_T = 58;
OFF_GRID_POWER_PHASE_T = 59;
