...
namespace esphome {
    namespace sofarsolar_inverter {
        ...
        SofarSolar_Inverter::SofarSolar_Inverter() {
			this->G3_dynamic = {
				{PV_GENERATION_TODAY, SofarSolar_RegisterDynamic{pv_generation_today_sensor_, pv_generation_today_sensor_update_interval_ * 1000, {}, false, false}}, // PV Generation Today
        	    {PV_GENERATION_TOTAL, SofarSolar_RegisterDynamic{pv_generation_total_sensor_, pv_generation_total_sensor_update_interval_ * 1000, {}, false, false}}, // PV Generation Total
    	        {LOAD_CONSUMPTION_TODAY, SofarSolar_RegisterDynamic{load_consumption_today_sensor_, load_consumption_today_sensor_update_interval_ * 1000, {}, false, false}}, // Load Consumption Today
    			{LOAD_CONSUMPTION_TOTAL, SofarSolar_RegisterDynamic{load_consumption_total_sensor_, load_consumption_total_sensor_update_interval_ * 1000, {}, false, false}}, // Load Consumption Total
            	{BATTERY_CHARGE_TODAY, SofarSolar_RegisterDynamic{battery_charge_today_sensor_, battery_charge_today_sensor_update_interval_ * 1000, {}, false, false}}, // Battery Charge Today
        	    {BATTERY_CHARGE_TOTAL, SofarSolar_RegisterDynamic{battery_charge_total_sensor_, battery_charge_total_sensor_update_interval_ * 1000, {}, false, false}}, // Battery Charge Total
    	        {BATTERY_DISCHARGE_TODAY, SofarSolar_RegisterDynamic{battery_discharge_today_sensor_, battery_discharge_today_sensor_update_interval_ * 1000, {}, false, false}}, // Battery Discharge Today
	            {BATTERY_DISCHARGE_TOTAL, SofarSolar_RegisterDynamic{battery_discharge_total_sensor_ ,battery_discharge_total_sensor_update_interval_ * 1000 ,{}, false ,false}}, // Battery Discharge Total
            	{TOTAL_ACTIVE_POWER_INVERTER, SofarSolar_RegisterDynamic{total_active_power_inverter_sensor_ ,total_active_power_inverter_sensor_update_interval_ * 1000 ,{}, false ,false}}, // Total Active Power Inverter
        	    {PV_VOLTAGE_1, SofarSolar_RegisterDynamic{pv_voltage_1_sensor_ ,pv_voltage_1_sensor_update_interval_ * 1000 ,{}, false ,false}}, // PV Voltage 1
    	        {PV_CURRENT_1, SofarSolar_RegisterDynamic{pv_current_1_sensor_ ,pv_current_1_sensor_update_interval_ * 1000 ,{}, false ,false}}, // PV Current 1
	            {PV_POWER_1, SofarSolar_RegisterDynamic{pv_power_1_sensor_ ,pv_power_1_sensor_update_interval_ * 1000 ,{}, false ,false}}, // PV Power 1
            	{PV_VOLTAGE_2, SofarSolar_RegisterDynamic{pv_voltage_2_sensor_ ,pv_voltage_2_sensor_update_interval_ * 1000 ,{}, false ,false}}, // PV Voltage 2
        	    {PV_CURRENT_2, SofarSolar_RegisterDynamic{pv_current_2_sensor_ ,pv_current_2_sensor_update_interval_ * 1000 ,{}, false ,false}}, // PV Current 2
    	        {PV_POWER_2, SofarSolar_RegisterDynamic{pv_power_2_sensor_, pv_power_2_sensor_update_interval_ * 1000, {}, false, false}}, // PV Power 2
	            {PV_POWER_TOTAL, SofarSolar_RegisterDynamic{pv_power_total_sensor_, pv_power_total_sensor_update_interval_ * 1000, {}, false, false}}, // PV Power Total
            	{BATTERY_POWER_TOTAL, SofarSolar_RegisterDynamic{battery_power_total_sensor_, battery_power_total_sensor_update_interval_ * 1000, {}, false, false}}, // Battery Power Total
        	    {BATTERY_STATE_OF_CHARGE_TOTAL, SofarSolar_RegisterDynamic{battery_state_of_charge_total_sensor_, battery_state_of_charge_total_sensor_update_interval_ * 1000, {}, false, false}}, // Battery State of Charge Total
    	        {DESIRED_GRID_POWER, SofarSolar_RegisterDynamic{desired_grid_power_sensor_, desired_grid_power_sensor_update_interval_ * 1000, desired_grid_power_sensor_default_value_, desired_grid_power_sensor_default_value_set_, desired_grid_power_sensor_enforce_default_value_}}, // Desired Grid Power
				{MINIMUM_BATTERY_POWER, SofarSolar_RegisterDynamic{minimum_battery_power_sensor_, minimum_battery_power_sensor_update_interval_ * 1000, minimum_battery_power_sensor_default_value_, minimum_battery_power_sensor_default_value_set_, minimum_battery_power_sensor_enforce_default_value_}}, // Minimum Battery Power
				{MAXIMUM_BATTERY_POWER, SofarSolar_RegisterDynamic{maximum_battery_power_sensor_, maximum_battery_power_sensor_update_interval_ * 1000, maximum_battery_power_sensor_default_value_, maximum_battery_power_sensor_default_value_set_, maximum_battery_power_sensor_enforce_default_value_}}, // Maximum Battery Power
				{ENERGY_STORAGE_MODE, SofarSolar_RegisterDynamic{energy_storage_mode_sensor_, energy_storage_mode_sensor_update_interval_ * 1000, energy_storage_mode_sensor_default_value_, energy_storage_mode_sensor_default_value_set_, energy_storage_mode_sensor_enforce_default_value_}}, // Energy Storage Mode
				{BATTERY_CONF_ID, SofarSolar_RegisterDynamic{battery_conf_id_sensor_, battery_conf_id_sensor_update_interval_ * 1000, battery_conf_id_sensor_default_value_, battery_conf_id_sensor_default_value_set_, battery_conf_id_sensor_enforce_default_value_}}, // Battery Conf ID
				{BATTERY_CONF_ADDRESS, SofarSolar_RegisterDynamic{battery_conf_address_sensor_, battery_conf_address_sensor_update_interval_ * 1000, battery_conf_address_sensor_default_value_, battery_conf_address_sensor_default_value_set_, battery_conf_address_sensor_enforce_default_value_}}, // Battery Conf Address
				{BATTERY_CONF_PROTOCOL, SofarSolar_RegisterDynamic{battery_conf_protocol_sensor_, battery_conf_protocol_sensor_update_interval_ * 1000, battery_conf_protocol_sensor_default_value_, battery_conf_protocol_sensor_default_value_set_, battery_conf_protocol_sensor_enforce_default_value_}}, // Battery Conf Protocol
				{BATTERY_CONF_VOLTAGE_NOMINAL, SofarSolar_RegisterDynamic{battery_conf_voltage_nominal_sensor_, battery_conf_voltage_nominal_sensor_update_interval_ * 1000, battery_conf_voltage_nominal_sensor_default_value_, battery_conf_voltage_nominal_sensor_default_value_set_, battery_conf_voltage_nominal_sensor_enforce_default_value_}}, // Battery Conf Voltage Nominal
				{BATTERY_CONF_VOLTAGE_OVER, SofarSolar_RegisterDynamic{battery_conf_voltage_over_sensor_, battery_conf_voltage_over_sensor_update_interval_ * 1000, battery_conf_voltage_over_sensor_default_value_, battery_conf_voltage_over_sensor_default_value_set_, battery_conf_voltage_over_sensor_enforce_default_value_}}, // Battery Conf Voltage Over
				{BATTERY_CONF_VOLTAGE_CHARGE, SofarSolar_RegisterDynamic{battery_conf_voltage_charge_sensor_, battery_conf_voltage_charge_sensor_update_interval_ * 1000, battery_conf_voltage_charge_sensor_default_value_, battery_conf_voltage_charge_sensor_default_value_set_, battery_conf_voltage_charge_sensor_enforce_default_value_}}, // Battery Conf Voltage Charge
				{BATTERY_CONF_VOLTAGE_LACK, SofarSolar_RegisterDynamic{battery_conf_voltage_lack_sensor_ ,battery_conf_voltage_lack_sensor_update_interval_ * 1000 , battery_conf_voltage_lack_sensor_default_value_, battery_conf_voltage_lack_sensor_default_value_set_ ,battery_conf_voltage_lack_sensor_enforce_default_value_}}, // Battery Conf Voltage Lack
				{BATTERY_CONF_VOLTAGE_DISCHARGE_STOP, SofarSolar_RegisterDynamic{battery_conf_voltage_discharge_stop_sensor_ ,battery_conf_voltage_discharge_stop_sensor_update_interval_ * 1000 , battery_conf_voltage_discharge_stop_sensor_default_value_, battery_conf_voltage_discharge_stop_sensor_default_value_set_ ,battery_conf_voltage_discharge_stop_sensor_enforce_default_value_}}, // Battery Conf Voltage Discharge Stop
				{BATTERY_CONF_CURRENT_CHARGE_LIMIT, SofarSolar_RegisterDynamic{battery_conf_current_charge_limit_sensor_, battery_conf_current_charge_limit_sensor_update_interval_ * 1000, battery_conf_current_charge_limit_sensor_default_value_, battery_conf_current_charge_limit_sensor_default_value_set_, battery_conf_current_charge_limit_sensor_enforce_default_value_}}, // Battery Conf Current Charge Limit
				{BATTERY_CONF_CURRENT_DISCHARGE_LIMIT, SofarSolar_RegisterDynamic{battery_conf_current_discharge_limit_sensor_, battery_conf_current_discharge_limit_sensor_update_interval_ * 1000, battery_conf_current_discharge_limit_sensor_default_value_, battery_conf_current_discharge_limit_sensor_default_value_set_, battery_conf_current_discharge_limit_sensor_enforce_default_value_}}, // Battery Conf Current Discharge Limit
				{BATTERY_CONF_DEPTH_OF_DISCHARGE, SofarSolar_RegisterDynamic{battery_conf_depth_of_discharge_sensor_, battery_conf_depth_of_discharge_sensor_update_interval_ * 1000, battery_conf_depth_of_discharge_sensor_default_value_, battery_conf_depth_of_discharge_sensor_default_value_set_, battery_conf_depth_of_discharge_sensor_enforce_default_value_}}, // Battery Conf Depth of Discharge
				{BATTERY_CONF_END_OF_DISCHARGE, SofarSolar_RegisterDynamic{battery_conf_end_of_discharge_sensor_ ,battery_conf_end_of_discharge_sensor_update_interval_ * 1000 , battery_conf_end_of_discharge_sensor_default_value_, battery_conf_end_of_discharge_sensor_default_value_set_ ,battery_conf_end_of_discharge_sensor_enforce_default_value_}}, // Battery Conf End of Discharge
				{BATTERY_CONF_CAPACITY, SofarSolar_RegisterDynamic{battery_conf_capacity_sensor_ ,battery_conf_capacity_sensor_update_interval_ * 1000, battery_conf_capacity_sensor_default_value_, battery_conf_capacity_sensor_default_value_set_ ,battery_conf_capacity_sensor_enforce_default_value_}}, // Battery Conf Capacity
				{BATTERY_CONF_CELL_TYPE, SofarSolar_RegisterDynamic{battery_conf_cell_type_sensor_, battery_conf_cell_type_sensor_update_interval_ * 1000, battery_conf_cell_type_sensor_default_value_, battery_conf_cell_type_sensor_default_value_set_, battery_conf_cell_type_sensor_enforce_default_value_}}, // Battery Conf Cell Type
				{BATTERY_CONF_EPS_BUFFER, SofarSolar_RegisterDynamic{battery_conf_eps_buffer_sensor_, battery_conf_eps_buffer_sensor_update_interval_ * 1000, battery_conf_eps_buffer_sensor_default_value_, battery_conf_eps_buffer_sensor_default_value_set_, battery_conf_eps_buffer_sensor_enforce_default_value_}}, // Battery Conf EPS Buffer
				{BATTERY_CONF_CONTROL, SofarSolar_RegisterDynamic{battery_conf_control_sensor_ ,battery_conf_control_sensor_update_interval_ * 1000 ,{}, false ,false}}, // Battery Conf Control
				{GRID_FREQUENCY, SofarSolar_RegisterDynamic{grid_frequency_sensor_ ,grid_frequency_sensor_update_interval_ * 1000 ,{}, false ,false}}, // Grid Frequency
				{GRID_VOLTAGE_PHASE_R, SofarSolar_RegisterDynamic{grid_voltage_phase_r_sensor_ ,grid_voltage_phase_r_sensor_update_interval_ * 1000 ,{}, false ,false}}, // Grid Voltage Phase R
				{GRID_CURRENT_PHASE_R, SofarSolar_RegisterDynamic{grid_current_phase_r_sensor_, grid_current_phase_r_sensor_update_interval_ * 1000, {}, false, false}}, // Grid Current Phase R
				{GRID_POWER_PHASE_R, SofarSolar_RegisterDynamic{grid_power_phase_r_sensor_, grid_power_phase_r_sensor_update_interval_ * 1000, {}, false, false}}, // Grid Power Phase R
				{GRID_VOLTAGE_PHASE_S, SofarSolar_RegisterDynamic{grid_voltage_phase_s_sensor_, grid_voltage_phase_s_sensor_update_interval_ * 1000, {}, false, false}}, // Grid Voltage Phase S
				{GRID_CURRENT_PHASE_S, SofarSolar_RegisterDynamic{grid_current_phase_s_sensor_, grid_current_phase_s_sensor_update_interval_ * 1000, {}, false, false}}, // Grid Current Phase S
				{GRID_POWER_PHASE_S, SofarSolar_RegisterDynamic{grid_power_phase_s_sensor_, grid_power_phase_s_sensor_update_interval_ * 1000, {}, false, false}}, // Grid Power Phase S
				{GRID_VOLTAGE_PHASE_T, SofarSolar_RegisterDynamic{grid_voltage_phase_t_sensor_, grid_voltage_phase_t_sensor_update_interval_ * 1000, {}, false, false}}, // Grid Voltage Phase T
				{GRID_CURRENT_PHASE_T, SofarSolar_RegisterDynamic{grid_current_phase_t_sensor_, grid_current_phase_t_sensor_update_interval_ * 1000, {}, false, false}}, // Grid Current Phase T
				{GRID_POWER_PHASE_T, SofarSolar_RegisterDynamic{grid_power_phase_t_sensor_, grid_power_phase_t_sensor_update_interval_ * 1000, {}, false, false}}, // Grid Power Phase T
				{OFF_GRID_POWER_TOTAL, SofarSolar_RegisterDynamic{off_grid_power_total_sensor_ ,off_grid_power_total_sensor_update_interval_ * 1000 ,{}, false ,false}}, // Off Grid Power Total
				{OFF_GRID_FREQUENCY, SofarSolar_RegisterDynamic{off_grid_frequency_sensor_, off_grid_frequency_sensor_update_interval_ * 1000, {}, false, false}}, // Off Grid Frequency
				{OFF_GRID_VOLTAGE_PHASE_R, SofarSolar_RegisterDynamic{off_grid_voltage_phase_r_sensor_ ,off_grid_voltage_phase_r_sensor_update_interval_ * 1000 ,{}, false ,false}}, // Off Grid Voltage Phase R
				{OFF_GRID_CURRENT_PHASE_R, SofarSolar_RegisterDynamic{off_grid_current_phase_r_sensor_ ,off_grid_current_phase_r_sensor_update_interval_ * 1000 ,{}, false ,false}}, // Off Grid Current Phase R
				{OFF_GRID_POWER_PHASE_R, SofarSolar_RegisterDynamic{off_grid_power_phase_r_sensor_ ,off_grid_power_phase_r_sensor_update_interval_ * 1000 ,{}, false ,false}}, // Off Grid Power Phase R
				{OFF_GRID_VOLTAGE_PHASE_S, SofarSolar_RegisterDynamic{off_grid_voltage_phase_s_sensor_, off_grid_voltage_phase_s_sensor_update_interval_ * 1000, {}, false, false}}, // Off Grid Voltage Phase S
				{OFF_GRID_CURRENT_PHASE_S, SofarSolar_RegisterDynamic{off_grid_current_phase_s_sensor_, off_grid_current_phase_s_sensor_update_interval_ * 1000, {}, false, false}}, // Off Grid Current Phase S
				{OFF_GRID_POWER_PHASE_S, SofarSolar_RegisterDynamic{off_grid_power_phase_s_sensor_, off_grid_power_phase_s_sensor_update_interval_ * 1000, {}, false, false}}, // Off Grid Power Phase S
				{OFF_GRID_VOLTAGE_PHASE_T, SofarSolar_RegisterDynamic{off_grid_voltage_phase_t_sensor_ ,off_grid_voltage_phase_t_sensor_update_interval_ * 1000 ,{}, false ,false}}, // Off Grid Voltage Phase T
				{OFF_GRID_CURRENT_PHASE_T, SofarSolar_RegisterDynamic{off_grid_current_phase_t_sensor_, off_grid_current_phase_t_sensor_update_interval_ * 1000, {}, false, false}}, // Off Grid Current Phase T
				{OFF_GRID_POWER_PHASE_T, SofarSolar_RegisterDynamic{off_grid_power_phase_t_sensor_, off_grid_power_phase_t_sensor_update_interval_ * 1000, {}, false, false}}, // Off Grid Power Phase T
				{BATTERY_ACTIVE_CONTROL, SofarSolar_RegisterDynamic{battery_active_control_sensor_, battery_active_control_sensor_update_interval_ * 1000, {}, false, false}}, // Battery Active Control
				{BATTERY_ACTIVE_ONESHOT, SofarSolar_RegisterDynamic{battery_active_oneshot_sensor_, battery_active_oneshot_sensor_update_interval_ * 1000, {}, false, false}} // Battery Active Oneshot
        	};
        }
