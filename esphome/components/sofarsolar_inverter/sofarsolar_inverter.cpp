...
namespace esphome {
    namespace sofarsolar_inverter {
        ...
        SofarSolar_Inverter::SofarSolar_Inverter() {
			...
			{LOAD_CONSUMPTION_TOTAL, SofarSolar_Register{0x068A, 2, 2, 0, 0.1, false}}, // Load Consumption Total
            {BATTERY_CHARGE_TODAY, SofarSolar_Register{0x0694, 2, 2, 1, 0.01, false}}, // Battery Charge Today
            {BATTERY_CHARGE_TOTAL, SofarSolar_Register{0x0696, 2, 2, 0, 0.1, false}}, // Battery Charge Total
            {BATTERY_DISCHARGE_TODAY, SofarSolar_Register{0x0698, 2, 2, 1, 0.01, false}}, // Battery Discharge Today
            {BATTERY_DISCHARGE_TOTAL, SofarSolar_Register{0x069A, 2, 2, 0, 0.1, false}}, // Battery Discharge Total
            {TOTAL_ACTIVE_POWER_INVERTER, SofarSolar_Register{0x0485, 1, 1, 3, 10 ,false}}, // Total Active Power Inverter
            {PV_VOLTAGE_1 ,SofarSolar_Register{0x0584 ,1 ,0 ,2 ,0.1 ,false}}, // PV Voltage 1
            {PV_CURRENT_1 ,SofarSolar_Register{0x0585 ,1 ,0 ,2 ,0.01 ,false}}, // PV Current 1
            {PV_POWER_1 ,SofarSolar_Register{0x0586 ,1 ,0 ,2 ,10 ,false}}, // PV Power 1
            {PV_VOLTAGE_2 ,SofarSolar_Register{0x0588 ,1 ,0 ,2 ,0.1 ,false}}, // PV Voltage 2
            {PV_CURRENT_2 ,SofarSolar_Register{0x0589 ,1 ,0 ,2 ,0.01 ,false}}, // PV Current 2
            {PV_POWER_2 ,SofarSolar_Register{0x058A ,1 ,0 ,2 ,10 ,false}}, // PV Power 2
            ...
            {GRID_VOLTAGE_PHASE_S, SofarSolar_Register{0x058C ,1 ,0 ,2 ,0.1 ,false}}, // Grid Voltage Phase S
            {GRID_CURRENT_PHASE_S, SofarSolar_Register{0x058D ,1 ,0 ,2 ,0.01 ,false}}, // Grid Current Phase S
            {GRID_POWER_PHASE_S, SofarSolar_Register{0x058E ,1 ,0 ,2 ,10 ,false}}, // Grid Power Phase S
            {GRID_VOLTAGE_PHASE_T, SofarSolar_Register{0x0598 ,1 ,0 ,2 ,0.1 ,false}}, // Grid Voltage Phase T
            {GRID_CURRENT_PHASE_T, SofarSolar_Register{0x0599 ,1 ,0 ,2 ,0.01 ,false}}, // Grid Current Phase T
            {GRID_POWER_PHASE_T, SofarSolar_Register{0x059A ,1 ,0 ,2 ,10 ,false}}, // Grid Power Phase T
            {OFF_GRID_POWER_TOTAL, SofarSolar_Register{0x05A4 ,1 ,0 ,3 ,100 ,false}}, // Off Grid Power Total
            {OFF_GRID_FREQUENCY, SofarSolar_Register{0x05A5, 1, 0, 2, 0.01, false}}, // Off Grid Frequency
            {OFF_GRID_VOLTAGE_PHASE_R, SofarSolar_Register{0x05A6 ,1 ,0 ,2 ,0.1 ,false}}, // Off Grid Voltage Phase R
            {OFF_GRID_CURRENT_PHASE_R, SofarSolar_Register{0x05A7 ,1 ,0 ,2 ,0.01 ,false}}, // Off Grid Current Phase R
            {OFF_GRID_POWER_PHASE_R, SofarSolar_Register{0x05A8 ,1 ,0 ,2 ,10 ,false}}, // Off Grid Power Phase R
            {OFF_GRID_VOLTAGE_PHASE_S, SofarSolar_Register{0x05AC ,1 ,0 ,2 ,0.1 ,false}}, // Off Grid Voltage Phase S
            {OFF_GRID_CURRENT_PHASE_S, SofarSolar_Register{0x05AD ,1 ,0 ,2 ,0.01 ,false}}, // Off Grid Current Phase S
            {OFF_GRID_POWER_PHASE_S, SofarSolar_Register{0x05AE ,1 ,0 ,2 ,10 ,false}}, // Off Grid Power Phase S
        ...
        void set_pv_generation_today_sensor_update_interval(int pv_generation_today_sensor_update_interval) { registers_G3[PV_GENERATION_TODAY].update_interval = pv_generation_today_sensor_update_interval; pv_generation_today_sensor_update_interval_ = pv_generation_today_sensor_update_interval; }
        void set_pv_generation_total_sensor_update_interval(int pv_generation_total_sensor_update_interval) { registers_G3[PV_GENERATION_TOTAL].update_interval = pv_generation_total_sensor_update_interval; pv_generation_total_sensor_update_interval_ = pv_generation_total_sensor_update_interval; }
        void set_load_consumption_today_sensor_update_interval(int load_consumption_today_sensor_update_interval) { registers_G3[LOAD_CONSUMPTION_TODAY].update_interval = load_consumption_today_sensor_update_interval; load_consumption_today_sensor_update_interval_ = load_consumption_today_sensor_update_interval; }
        void set_load_consumption_total_sensor_update_interval(int load_consumption_total_sensor_update_interval) { registers_G3[LOAD_CONSUMPTION_TOTAL].update_interval = load_consumption_total_sensor_update_interval; load_consumption_total_sensor_update_interval_ = load_consumption_total_sensor_update_interval; }
        void set_battery_charge_today_sensor_update_interval(int battery_charge_today_sensor_update_interval) { registers_G3[BATTERY_CHARGE_TODAY].update_interval = battery_charge_today_sensor_update_interval; battery_charge_today_sensor_update_interval_ = battery_charge_today_sensor_update_interval; }
        void set_battery_charge_total_sensor_update_interval(int battery_charge_total_sensor_update_interval) { registers_G3[BATTERY_CHARGE_TOTAL].update_interval = battery_charge_total_sensor_update_interval; battery_charge_total_sensor_update_interval_ = battery_charge_total_sensor_update_interval; }
        ...
        void set_battery_discharge_total_sensor_update_interval(int battery_discharge_total_sensor_update_interval) { registers_G3[BATTERY_DISCHARGE_TOTAL].update_interval = battery_discharge_total_sensor_update_interval; battery_discharge_total_sensor_update_interval_ = battery_discharge_total_sensor_update_interval; }
        void set_total_active_power_inverter_sensor_update_interval(int total_active_power_inverter_sensor_update_interval) { registers_G3[TOTAL_ACTIVE_POWER_INVERTER].update_interval = total_active_power_inverter_sensor_update_interval; total_active_power_inverter_sensor_update_interval_ = total_active_power_inverter_sensor_update_interval; }
        void set_pv_voltage_1_sensor_update_interval(int pv_voltage_1_sensor_update_interval) { registers_G3[PV_VOLTAGE_1].update_interval = pv_voltage_1_sensor_update_interval; pv_voltage_1_sensor_update_interval_ = pv_voltage_1_sensor_update_interval; }
        void set_pv_current_1_sensor_update_interval(int pv_current_1_sensor_update_interval) { registers_G3[PV_CURRENT_1].update_interval = pv_current_1_sensor_update_interval; pv_current_1_sensor_update_interval_ = pv_current_1_sensor_update_interval; }
        void set_pv_power_1_sensor_update_interval(int pv_power_1_sensor_update_interval) { registers_G3[PV_POWER_1].update_interval = pv_power_1_sensor_update_interval; pv_power_1_sensor_update_interval_ = pv_power_1_sensor_update_interval; }
        void set_pv_voltage_2_sensor_update_interval(int pv_voltage_2_sensor_update_interval) { registers_G3[PV_VOLTAGE_2].update_interval = pv_voltage_2_sensor_update_interval; pv_voltage_2_sensor_update_interval_ = pv_voltage_2_sensor_update_interval; }
        void set_pv_current_2_sensor_update_interval(int pv_current_2_sensor_update_interval) { registers_G3[PV_CURRENT_2].update_interval = pv_current_2_sensor_update_interval; pv_current_2_sensor_update_interval_ = pv_current_2_sensor_update_interval; }
        void set_pv_power_2_sensor_update_interval(int pv_power_2_sensor_update_interval) { registers_G3[PV_POWER_2].update_interval = pv_power_2_sensor_update_interval; pv_power_2_sensor_update_interval_ = pv_power_2_sensor_update_interval; }
        void set_pv_power_total_sensor_update_interval(int pv_power_total_sensor_update_interval) { registers_G3[PV_POWER_TOTAL].update_interval = pv_power_total_sensor_update_interval; pv_power_total_sensor_update_interval_ = pv_power_total_sensor_update_interval; }
        void set_battery_power_total_sensor_update_interval(int battery_power_total_sensor_update_interval) { registers_G3[BATTERY_POWER_TOTAL].update_interval = battery_power_total_sensor_update_interval; battery_power_total_sensor_update_interval_ = battery_power_total_sensor_update_interval; }
        ...
        void set_desired_grid_power_sensor_update_interval(int desired_grid_power_sensor_update_interval) { registers_G3[DESIRED_GRID_POWER].update_interval = desired_grid_power_sensor_update_interval; desired_grid_power_sensor_update_interval_ = desired_grid_power_sensor_update_interval; }
        void set_minimum_battery_power_sensor_update_interval(int minimum_battery_power_sensor_update_interval) { registers_G3[MINIMUM_BATTERY_POWER].update_interval = minimum_battery_power_sensor_update_interval; minimum_battery_power_sensor_update_interval_ = minimum_battery_power_sensor_update_interval; }
        void set_maximum_battery_power_sensor_update_interval(int maximum_battery_power_sensor_update_interval) { registers_G3[MAXIMUM_BATTERY_POWER].update_interval = maximum_battery_power_sensor_update_interval; maximum_battery_power_sensor_update_interval_ = maximum_battery_power_sensor_update_interval; }
        void set_energy_storage_mode_sensor_update_interval(int energy_storage_mode_sensor_update_interval) { registers_G3[ENERGY_STORAGE_MODE].update_interval = energy_storage_mode_sensor_update_interval; energy_storage_mode_sensor_update_interval_ = energy_storage_mode_sensor_update_interval; }
        void set_battery_conf_id_sensor_update_interval(int battery_conf_id_sensor_update_interval) { registers_G3[BATTERY_CONF_ID].update_interval = battery_conf_id_sensor_update_interval; battery_conf_id_sensor_update_interval_ = battery_conf_id_sensor_update_interval; }
        void set_battery_conf_address_sensor_update_interval(int battery_conf_address_sensor_update_interval) { registers_G3[BATTERY_CONF_ADDRESS].update_interval = battery_conf_address_sensor_update_interval; battery_conf_address_sensor_update_interval_ = battery_conf_address_sensor_update_interval; }
        void set_battery_conf_protocol_sensor_update_interval(int battery_conf_protocol_sensor_update_interval) { registers_G3[BATTERY_CONF_PROTOCOL].update_interval = battery_conf_protocol_sensor_update_interval; battery_conf_protocol_sensor_update_interval_ = battery_conf_protocol_sensor_update_interval; }
        void set_battery_conf_voltage_nominal_sensor_update_interval(int battery_conf_voltage_nominal_sensor_update_interval) { registers_G3[BATTERY_CONF_VOLTAGE_NOMINAL].update_interval = battery_conf_voltage_nominal_sensor_update_interval; battery_conf_voltage_nominal_sensor_update_interval_ = battery_conf_voltage_nominal_sensor_update_interval; }
        void set_battery_conf_voltage_over_sensor_update_interval(int battery_conf_voltage_over_sensor_update_interval) { registers_G3[BATTERY_CONF_VOLTAGE_OVER].update_interval = battery_conf_voltage_over_sensor_update_interval; battery_conf_voltage_over_sensor_update_interval_ = battery_conf_voltage_over_sensor_update_interval; }
        ...
        void set_battery_conf_end_of_discharge_sensor_update_interval(int battery_conf_end_of_discharge_sensor_update_interval) { registers_G3[BATTERY_CONF_END_OF_DISCHARGE].update_interval = battery_conf_end_of_discharge_sensor_update_interval; battery_conf_end_of_discharge_sensor_update_interval_ = battery_conf_end_of_discharge_sensor_update_interval; }
        void set_battery_conf_capacity_sensor_update_interval(int battery_conf_capacity_sensor_update_interval) { registers_G3[BATTERY_CONF_CAPACITY].update_interval = battery_conf_capacity_sensor_update_interval; battery_conf_capacity_sensor_update_interval_ = battery_conf_capacity_sensor_update_interval; }
        void set_battery_conf_cell_type_sensor_update_interval(int battery_conf_cell_type_sensor_update_interval) { registers_G3[BATTERY_CONF_CELL_TYPE].update_interval = battery_conf_cell_type_sensor_update_interval; battery_conf_cell_type_sensor_update_interval_ = battery_conf_cell_type_sensor_update_interval; }
        void set_battery_conf_eps_buffer_sensor_update_interval(int battery_conf_eps_buffer_sensor_update_interval) { registers_G3[BATTERY_CONF_EPS_BUFFER].update_interval = battery_conf_eps_buffer_sensor_update_interval; battery_conf_eps_buffer_sensor_update_interval_ = battery_conf_eps_buffer_sensor_update_interval; }
        void set_battery_conf_control_sensor_update_interval(int battery_conf_control_sensor_update_interval) { registers_G3[BATTERY_CONF_CONTROL].update_interval = battery_conf_control_sensor_update_interval; battery_conf_control_sensor_update_interval_ = battery_conf_control_sensor_update_interval; }
        void set_grid_frequency_sensor_update_interval(int grid_frequency_sensor_update_interval) { registers_G3[GRID_FREQUENCY].update_interval = grid_frequency_sensor_update_interval; grid_frequency_sensor_update_interval_ = grid_frequency_sensor_update_interval; }
        void set_grid_voltage_phase_r_sensor_update_interval(int grid_voltage_phase_r_sensor_update_interval) { registers_G3[GRID_VOLTAGE_PHASE_R].update_interval = grid_voltage_phase_r_sensor_update_interval; grid_voltage_phase_r_sensor_update_interval_ = grid_voltage_phase_r_sensor_update_interval; }
        void set_grid_current_phase_r_sensor_update_interval(int grid_current_phase_r_sensor_update_interval) { registers_G3[GRID_CURRENT_PHASE_R].update_interval = grid_current_phase_r_sensor_update_interval; grid_current_phase_r_sensor_update_interval_ = grid_current_phase_r_sensor_update_interval; }
        void set_grid_power_phase_r_sensor_update_interval(int grid_power_phase_r_sensor_update_interval) { registers_G3[GRID_POWER_PHASE_R].update_interval = grid_power_phase_r_sensor_update_interval; grid_power_phase_r_sensor_update_interval_ = grid_power_phase_r_sensor_update_interval; }
        void set_grid_voltage_phase_s_sensor_update_interval(int grid_voltage_phase_s_sensor_update_interval) { registers_G3[GRID_VOLTAGE_PHASE_S].update_interval = grid_voltage_phase_s_sensor_update_interval; grid_voltage_phase_s_sensor_update_interval_ = grid_voltage_phase_s_sensor_update_interval; }
        void set_grid_current_phase_s_sensor_update_interval(int grid_current_phase_s_sensor_update_interval) { registers_G3[GRID_CURRENT_PHASE_S].update_interval = grid_current_phase_s_sensor_update_interval; grid_current_phase_s_sensor_update_interval_ = grid_current_phase_s_sensor_update_interval; }
        void set_grid_power_phase_s_sensor_update_interval(int grid_power_phase_s_sensor_update_interval) { registers_G3[GRID_POWER_PHASE_S].update_interval = grid_power_phase_s_sensor_update_interval; grid_power_phase_s_sensor_update_interval_ = grid_power_phase_s_sensor_update_interval; }
        void set_grid_voltage_phase_t_sensor_update_interval(int grid_voltage_phase_t_sensor_update_interval) { registers_G3[GRID_VOLTAGE_PHASE_T].update_interval = grid_voltage_phase_t_sensor_update_interval; grid_voltage_phase_t_sensor_update_interval_ = grid_voltage_phase_t_sensor_update_interval; }
        void set_grid_current_phase_t_sensor_update_interval(int grid_current_phase_t_sensor_update_interval) { registers_G3[GRID_CURRENT_PHASE_T].update_interval = grid_current_phase_t_sensor_update_interval; grid_current_phase_t_sensor_update_interval_ = grid_current_phase_t_sensor_update_interval; }
        void set_grid_power_phase_t_sensor_update_interval(int grid_power_phase_t_sensor_update_interval) { registers_G3[GRID_POWER_PHASE_T].update_interval = grid_power_phase_t_sensor_update_interval; grid_power_phase_t_sensor_update_interval_ = grid_power_phase_t_sensor_update_interval; }
        void set_off_grid_power_total_sensor_update_interval(int off_grid_power_total_sensor_update_interval) { registers_G3[OFF_GRID_POWER_TOTAL].update_interval = off_grid_power_total_sensor_update_interval; off_grid_power_total_sensor_update_interval_ = off_grid_power_total_sensor_update_interval; }
        void set_off_grid_frequency_sensor_update_interval(int off_grid_frequency_sensor_update_interval) { registers_G3[OFF_GRID_FREQUENCY].update_interval = off_grid_frequency_sensor_update_interval; off_grid_frequency_sensor_update_interval_ = off_grid_frequency_sensor_update_interval; }
        void set_off_grid_voltage_phase_r_sensor_update_interval(int off_grid_voltage_phase_r_sensor_update_interval) { registers_G3[OFF_GRID_VOLTAGE_PHASE_R].update_interval = off_grid_voltage_phase_r_sensor_update_interval; off_grid_voltage_phase_r_sensor_update_interval_ = off_grid_voltage_phase_r_sensor_update_interval; }
        void set_off_grid_current_phase_r_sensor_update_interval(int off_grid_current_phase_r_sensor_update_interval) { registers_G3[OFF_GRID_CURRENT_PHASE_R].update_interval = off_grid_current_phase_r_sensor_update_interval; off_grid_current_phase_r_sensor_update_interval_ = off_grid_current_phase_r_sensor_update_interval; }
        void set_off_grid_power_phase_r_sensor_update_interval(int off_grid_power_phase_r_sensor_update_interval) { registers_G3[OFF_GRID_POWER_PHASE_R].update_interval = off_grid_power_phase_r_sensor_update_interval; off_grid_power_phase_r_sensor_update_interval_ = off_grid_power_phase_r_sensor_update_interval; }
        ...
        void set_off_grid_current_phase_s_sensor_update_interval(int off_grid_current_phase_s_sensor_update_interval) { registers_G3[OFF_GRID_CURRENT_PHASE_S].update_interval = off_grid_current_phase_s_sensor_update_interval; off_grid_current_phase_s_sensor_update_interval_ = off_grid_current_phase_s_sensor_update_interval; }
        void set_off_grid_power_phase_s_sensor_update_interval(int off_grid_power_phase_s_sensor_update_interval) { registers_G3[OFF_GRID_POWER_PHASE_S].update_interval = off_grid_power_phase_s_sensor_update_interval; off_grid_power_phase_s_sensor_update_interval_ = off_grid_power_phase_s_sensor_update_interval; }
        ...
        void set_off_grid_current_phase_t_sensor_update_interval(int off_grid_current_phase_t_sensor_update_interval) { registers_G3[OFF_GRID_CURRENT_PHASE_T].update_interval = off_grid_current_phase_t_sensor_update_interval; off_grid_current_phase_t_sensor_update_interval_ = off_grid_current_phase_t_sensor_update_interval; }
        void set_off_grid_power_phase_t_sensor_update_interval(int off_grid_power_phase_t_sensor_update_interval) { registers_G3[OFF_GRID_POWER_PHASE_T].update_interval = off_grid_power_phase_t_sensor_update_interval; off_grid_power_phase_t_sensor_update_interval_ = off_grid_power_phase_t_sensor_update_interval; }


        void set_desired_grid_power_sensor_default_value(int64_t default_value) { registers_G3[DESIRED_GRID_POWER].default_value.int64_value = default_value; registers_G3[18].is_default_value_set = true; }
        void set_minimum_battery_power_sensor_default_value(int64_t default_value) { registers_G3[MINIMUM_BATTERY_POWER].default_value.int64_value = default_value; registers_G3[19].is_default_value_set = true; }
		void set_maximum_battery_power_sensor_default_value(int64_t default_value) { registers_G3[MAXIMUM_BATTERY_POWER].default_value.int64_value = default_value; registers_G3[20].is_default_value_set = true; }
		void set_energy_storage_mode_sensor_default_value(int64_t default_value) { registers_G3[ENERGY_STORAGE_MODE].default_value.int64_value = default_value; registers_G3[21].is_default_value_set = true; }
		void set_battery_conf_id_sensor_default_value(int64_t default_value) { registers_G3[BATTERY_CONF_ID].default_value.int64_value = default_value; registers_G3[22].is_default_value_set = true; }
		void set_battery_conf_address_sensor_default_value(int64_t default_value) { registers_G3[BATTEY_CONF_ADDRESS].default_value.int64_value = default_value; registers_G3[23].is_default_value_set = true; }
		void set_battery_conf_protocol_sensor_default_value(int64_t default_value) { registers_G3[BATTERY_CONF_PROTOCOL].default_value.int64_value = default_value; registers_G3[24].is_default_value_set = true; }
		void set_battery_conf_voltage_nominal_sensor_default_value(float default_value) { registers_G3[BATTERY_CONF_VOLTAGE_NOMINAL].default_value.int64_value = (int64_t) (default_value / registers_G3[25].scale); registers_G3[25].is_default_value_set = true; }
		void set_battery_conf_voltage_over_sensor_default_value(float default_value) { registers_G3[BATTERY_CONF_VOLTAGE_OVER].default_value.int64_value = (int64_t) (default_value / registers_G3[26].scale); registers_G3[26].is_default_value_set = true; }
		void set_battery_conf_voltage_charge_sensor_default_value(float default_value) { registers_G3[BATTERY_CONF_VOLTAGE_CHARGE].default_value.int64_value = (int64_t) (default_value / registers_G3[27].scale); registers_G3[27].is_default_value_set = true; }
		void set_battery_conf_voltage_lack_sensor_default_value(float default_value) { registers_G3[BATTERY_CONF_VOLTAGE_LACK].default_value.int64_value = (int64_t) (default_value / registers_G3[28].scale); registers_G3[28].is_default_value_set = true; }
		void set_battery_conf_voltage_discharge_stop_sensor_default_value(float default_value) { registers_G3[BATTERY_CONF_VOLTAGE_DISCHARGE_STOP].default_value.int64_value = (int64_t) (default_value / registers_G3[29].scale); registers_G3[29].is_default_value_set = true; }
		void set_battery_conf_current_charge_limit_sensor_default_value(float default_value) { registers_G3[BATTERY_CONF_CURRENT_CHARGE_LIMIT].default_value.int64_value = (int64_t) (default_value / registers_G3[30].scale); registers_G3[30].is_default_value_set = true; }
		void set_battery_conf_current_discharge_limit_sensor_default_value(float default_value) { registers_G3[BATTERY_CONF_CURRENT_DISCHARGE_LIMIT].default_value.int64_value = (int64_t) (default_value / registers_G3[31].scale); registers_G3[31].is_default_value_set = true; }
		void set_battery_conf_depth_of_discharge_sensor_default_value(int64_t default_value) { registers_G3[BATTERY_CONF_DEPTH_OF_DISCHARGE].default_value.int64_value = default_value; registers_G3[32].is_default_value_set = true; }
		void set_battery_conf_end_of_discharge_sensor_default_value(int64_t default_value) { registers_G3[BATTERY_CONF_END_OF_DISCHARGE].default_value.int64_value = default_value; registers_G3[33].is_default_value_set = true; }
		void set_battery_conf_capacity_sensor_default_value(int64_t default_value) { registers_G3[BATTERY_CONF_CAPACITY].default_value.int64_value = default_value; registers_G3[34].is_default_value_set = true; }
		void set_battery_conf_cell_type_sensor_default_value(int64_t default_value) { registers_G3[BATTERY_CONF_CELL_TYPE].default_value.int64_value = default_value; registers_G3[35].is_default_value_set = true; }
		void set_battery_conf_eps_buffer_sensor_default_value(int64_t default_value) { registers_G3[BATTERY_CONF_EPS_BUFFER].default_value.int64_value = default_value; registers_G3[36].is_default_value_set = true; }

		void set_desired_grid_power_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[DESIRED_GRID_POWER].enforce_default_value = enforce_default_value; }
		void set_minimum_battery_power_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[MINIMUM_BATTERY_POWER].enforce_default_value = enforce_default_value; }
		void set_maximum_battery_power_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[MAXIMUM_BATTERY_POWER].enforce_default_value = enforce_default_value; }
		void set_energy_storage_mode_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[ENERGY_STORAGE_MODE].enforce_default_value = enforce_default_value; }
		void set_battery_conf_id_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_ID].enforce_default_value = enforce_default_value; }
		void set_battery_conf_address_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_ADDRESS].enforce_default_value = enforce_default_value; }
		void set_battery_conf_protocol_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_PROTOCOL].enforce_default_value = enforce_default_value; }
		void set_battery_conf_voltage_nominal_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_VOLTAGE_NOMINAL].enforce_default_value = enforce_default_value; }
		void set_battery_conf_voltage_over_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_VOLTAGE_OVER].enforce_default_value = enforce_default_value; }
		void set_battery_conf_voltage_charge_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_VOLTAGE_CHARGE].enforce_default_value = enforce_default_value; }
		void set_battery_conf_voltage_lack_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_VOLTAGE_LACK].enforce_default_value = enforce_default_value; }
		void set_battery_conf_voltage_discharge_stop_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_VOLTAGE_DISCHARGE_STOP].enforce_default_value = enforce_default_value; }
		void set_battery_conf_current_charge_limit_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_CURRENT_CHARGE_LIMIT].enforce_default_value = enforce_default_value; }
		void set_battery_conf_current_discharge_limit_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_CURRENT_DISCHARGE_LIMIT].enforce_default_value = enforce_default_value; }
		void set_battery_conf_depth_of_discharge_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_DEPTH_OF_DISCHARGE].enforce_default_value = enforce_default_value; }
		void set_battery_conf_end_of_discharge_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_END_OF_DISCHARGE].enforce_default_value = enforce_default_value; }
		void set_battery_conf_capacity_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_CAPACITY].enforce_default_value = enforce_default_value; }
		void set_battery_conf_cell_type_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_CELL_TYPE].enforce_default_value = enforce_default_value; }
		void set_battery_conf_eps_buffer_sensor_enforce_default_value(bool enforce_default_value) { registers_G3[BATTERY_CONF_EPS_BUFFER].enforce_default_value = enforce_default_value; }
    }
}