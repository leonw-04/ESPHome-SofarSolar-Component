...
namespace esphome {
    namespace sofarsolar_inverter {
		...
		void SofarSolar_Inverter::set_battery_conf_address_sensor_default_value(int64_t default_value) { registers_G3[BATTEY_CONF_ADDRESS].default_value.int64_value = default_value; registers_G3[23].is_default_value_set = true; }
