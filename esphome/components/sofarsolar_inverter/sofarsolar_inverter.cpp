...
namespace esphome
{
	namespace sofarsolar_inverter {
		...
		void SofarSolar_Inverter::set_passive_timeout_action_sensor_update_interval(uint16_t passive_timeout_action_sensor_update_interval) { G3_dynamic.at(PASSIVE_TIMEOUT_ACTIVE).update_interval = passive_timeout_action_sensor_update_interval * 1000; }
